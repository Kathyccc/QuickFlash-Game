...
CACHES = {
    'default': {
        ...
        'LOCATION': 'my_cache_table',  # Use a table in the database for caching
    }
}
...
# LOGIN_REDIRECT_URL = '/'
LOGIN_REDIRECT_URL = '/oauth-login-redirect'
...
CSRF_TRUSTED_ORIGINS = ['http://www.quickflashgame.me', 'http://quickflashgame.me', 'https://www.quickflashgame.me', 'https://quickflashgame.me']